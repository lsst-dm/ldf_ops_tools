...
sql = 'insert into visit_tag (camsym, visit, ccd, tag) values (%s, %s, %s, %s)' % (dbh.get_named_bind_string('camsym'),
dbh.get_named_bind_string('visit'), dbh.get_named_bind_string('ccd'), dbh.get_named_bind_string('tag'))
